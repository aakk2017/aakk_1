...
const messages_zhCN = {
  ...
  settingsDialog: {
    ...
    fields: {
      ...
      autoStrain: '自动定主',
      allowOverbase: '反扣底',
      overbaseRestrictions: '反扣底限制',
      failedMultiplayHandling: '甩牌失败处理',
      multiplayCompensationAmount: '甩牌补分数值',
      allowCrossings: '穿牌',
    ...
    scoringPresetHint: '上台 ≥ {stage} | 升级 +{level} | 上限: {limit}',
