...
const messages_zhCN = {
  ...
  log: {
    ...
    nobodyDeclared: '无人亮主',
    crossingClaimAccepted: '{playerName} 申报过河',
    crossingClaimIgnored: '{playerName} 试图申报过河，但该队已报过',
    crossingTimedOutNoClaim: '{playerName} 超时，不过河',
    crossingMoveDone: '{playerName} 向 {partnerName} 过河 5 张',
    crossingCrossbackDone: '{playerName} 向 {partnerName} 回河 5 张',
    crossingAllDone: '过河完成',
  ...
  settingsDialog: {
    ...
    options: {
      ...
      failedMultiplayLianZhongCompensation: '联众补分',
      experimental: '实验',
      plain: '平打',
      highSchool: '校园',
      berkeley: '伯克利',
