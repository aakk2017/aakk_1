...
const messages_en = {
  ...
  phase: {
    ...
    da3pStoppedBeforeBasing: 'DA3P dealing/declaration complete',
    da3pPivotResolvedStoppedBeforeBasing: 'DA3P pivot resolved; stopped before basing',
    da3pStoppedAtCountingEntry: 'DA3P reached counting-entry stop',
  ...
  status: {
    ...
    da3pSharedFlowNotImplemented: 'DA3P shared in-frame flow is not implemented yet.',
    da3pStoppedBeforeBasing: 'DA3P dealing/declaration complete — basing not implemented yet.',
    da3pPivotResolvedStoppedBeforeBasing: 'DA3P pivot resolved; stopped before basing.',
    da3pStoppedAtCountingEntry: 'DA3P reached counting-entry boundary; scoring and next-frame progression are not implemented yet.',
    da3pStoppedAtCountingEntryScore: 'DA3P counting-entry stop (provisional total score: {totalScore}).',
    gameOver:     'Game Over',
    paused:       'Game paused',
  },
  ...
  settingsDialog: {
    ...
    fields: {
      ...
      selectedDA3PReferenceActor: 'Select seat',
